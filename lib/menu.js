...
Whatsapp : private
Author? : Rizqi Hakim
Instagram: https://instagram.com/rizky.hakim
Github: Update soon
...
exports.textmenupenting = (pushname) => {
    return `
Hi Kak ${pushname}👋️, selamatt datang di Ribot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
https://www.instagram.com/rizky.hakim
Berikut fitur yang dapat di gunakan pada bot ini✨

List menu penting ribot:

Silahkan Yang ingin mendapatkan info ribot lebih cepat ketik 
${prefix}grup
tapi gk usah keluar masuk grup ya :)

🚀 *${prefix}addbacot*
Untuk melihat bacotan member ribot
...
🚀 *${prefix}listbacot*
Untuk melihat list bacotan member ribot
...
exports.textsongmenu = (pushname) => {
   return `
Hi Kak ${pushname}👋️, selamat datang di Ribot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
${sosmed}
Berikut fitur yang dapat di gunakan pada bot ini✨
...
*Ketik /chat* 
*Untuk Mengobrol dengan ribot*
*Jika ingin membuat sticker atau menu lainnya silahkan di offkan ribot chatnya*

List menu:

1. *${prefix}menupenting*
Menampilkan menu penting di ribot
Usage: ketik */menupenting*

2. *${prefix}menuhiburan*
Menampilkan menu hiburan di ribot
Usage: ketik */menuhiburan*

3. *${prefix}mentol*
Menampilkan menu tools & alat di ribot
Usage: ketik */mentol*
...
Ribot terdapat 2 menu sekarang
...
Untuk melihat Waktu Ribot Aktif
...
List menu wibuarea & kpop di ribot:
...
exports.textAdmin = () => {
    return `
⚠ [ *Admin Group Only* ] ⚠ 
Berikut adalah fitur admin grup yang ada pada ❣ *Ribot* ❣!
...
⚠ [ *Owner Group Only* ] ⚠
Berikut adalah fitur owner grup yang ada pada ❣ *Ribot* ❣!
🐼 *${prefix}kickall*
...
Kirim dana dengan hubungi melalui dm instagram
